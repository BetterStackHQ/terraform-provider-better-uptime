...
func TestResourceMonitorGroup(t *testing.T) {
	server := newResourceServer(t, "/api/v2/monitor-groups", "1")
	defer server.Close()
		...
		Steps: []resource.TestStep{
			// Step 1 - create.
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("betteruptime_monitor_group.this", "name", name),
			...
			// Step 2 - update.
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("betteruptime_monitor_group.this", "id"),
					resource.TestCheckResourceAttr("betteruptime_monitor_group.this", "name", name),
					resource.TestCheckResourceAttr("betteruptime_monitor_group.this", "sort_index", "0"),
				),
			},
