...
- `include_all_incidents_in_rss_feed` (Boolean) Publish every incident your monitors, heartbeats or integrations trigger to the status page RSS feed, including ones you never report on the status page. When false, the feed carries only the status updates you publish.
